...
databaseChangeLog(logicalFilePath: 'script/db/hmsg_template_server_wh.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-05-19-hmsg_template_server_wh") {
        ...
        createTable(tableName: "hmsg_template_server_wh", remarks: "消息发送配置webhook") {
            column(name: "temp_server_wh_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "temp_server_id", type: "bigint(20)",  remarks: "消息发送配置Id,hpfm_template_server.temp_server_id")  {constraints(nullable:"false")}  
            column(name: "temp_server_line_id", type: "bigint(20)",  remarks: "消息发送配置行Id，hpfm_template_server_line.temp_server_line_id")  {constraints(nullable:"false")}  
