...
public class ScheduleTaskVO {
    ...
    public ScheduleTaskVO(Long methodId) {
        this.methodId = methodId;
    }

    public ScheduleTaskVO(Long methodId, Map<String, Object> params, String name, String description, Date startTime, Long[] assignUserIds) {
