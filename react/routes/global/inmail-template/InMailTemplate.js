...
export default class InMailTemplate extends Component {
  ...
  createMailTemplate() {
    ...
    if (type === 'organization') {
      createUrl = `/notify/inmail-template/create?type=${type}&id=${orgId}&name=${orgName}&organizationId=${orgId}`;
    } else {
      createUrl = '/notify/inmail-template/create';
    }
  ...
  modifyMailTemplate = (id) => {
    ...
    let createUrl;
    if (type === 'organization') {
      createUrl = `/notify/inmail-template/modify/${id}?type=${type}&id=${orgId}&name=${orgName}&organizationId=${orgId}`;
    } else {
      createUrl = `/notify/inmail-template/modify/${id}`;
    }
    this.props.history.push(createUrl);
  }
