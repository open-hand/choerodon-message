...
export default class MailTemplate extends Component {
  ...
  createMailTemplate() {
    ...
    if (type === 'organization') {
      createUrl = `/notify/mail-template/create?type=${type}&id=${orgId}&name=${orgName}&organizationId=${orgId}`;
    } else {
      createUrl = '/notify/mail-template/create';
    }
  ...
  modifyMailTemplate = (id) => {
    ...
    let createUrl;
    if (type === 'organization') {
      createUrl = `/notify/mail-template/modify/${id}?type=${type}&id=${orgId}&name=${orgName}&organizationId=${orgId}`;
    } else {
      createUrl = `/notify/mail-template/modify/${id}`;
    }
    this.props.history.push(createUrl);
  }
